 ...
 * Validates URLs.
 * </p>
 * Behavour of validation is modified by passing in options: <li>ALLOW_2_SLASHES - [FALSE] Allows double '/' characters
 * in the path component.</li> <li>NO_FRAGMENT- [FALSE] By default fragments are allowed, if this option is included
 * then fragments are flagged as illegal.</li> <li>ALLOW_ALL_SCHEMES - [FALSE] By default only http, https, and ftp are
 ...
 * http://javascript.internet.com. However, this validation now bears little resemblance to the php original.
 * </p>
 * 
 * <pre>
 *   Example of usage:
...
//rightmost hostname will never start with a digit.
    ...
    protected boolean isValidPath(String path) {
        ...
        int dot2Count = countToken("src/main", path);
        if (dot2Count > 0) {
