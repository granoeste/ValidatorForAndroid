/*
 * $Id: GenericTypeValidator.java 293556 2005-10-04 07:07:32Z niallp $
 * $Rev: 293556 $
 * $Date: 2005-10-04 08:07:32 +0100 (Tue, 04 Oct 2005) $
 *
 * ====================================================================
...
public class GenericTypeValidator implements Serializable {
    ...
    /**
     * <p>
     * Checks if the field is a valid date. The <code>Locale</code> is used with <code>java.text.DateFormat</code>. The
     * setLenient method is set to <code>false</code> for all.
     * </p>
     * 
     * @param value The value validation is being performed on.
    ...
    /**
     * <p>
     * Checks if the field is a valid date. The pattern is used with <code>java.text.SimpleDateFormat</code> . If strict
     * is true, then the length will be checked so '2/12/1999' will not pass validation with the format 'MM/dd/yyyy'
     * because the month isn't two digits. The setLenient method is set to <code>false</code> for all.
     * </p>
     * 
     * @param value The value validation is being performed on.
     ...
     * </p>
     * <p>
     * Reference Sean M. Burke's <a href="http://www.ling.nwu.edu/~sburke/pub/luhn_lib.pl"> script</a> .
     * </p>
     * 
     * @param value The value validation is being performed on.
