/*
 * $Id: CreditCardValidator.java 280974 2005-09-15 00:06:59Z niallp $
 * $Rev: 280974 $
 ...
 * </p>
 * <p>
 * By default, all supported card types are allowed. You can specify which cards should pass validation by configuring
 * the validation options. For example,<br/>
 * <code>CreditCardValidator ccv = new CreditCardValidator(CreditCardValidator.AMEX + CreditCardValidator.VISA);</code>
 * configures the validator to only pass American Express and Visa cards. If a card type is not directly supported by
 * this class, you can implement the CreditCardType interface and pass an instance into the
...
public class CreditCardValidator {
    ...
    public interface CreditCardType {
         ...
         * for analyzing the general form of the card number because <code>CreditCardValidator</code> performs those
         * checks before
